...
CATEGORIES: list[dict[str, Any]] = [
    ...
    # --- Aesthetic clinic categories (Otomedis estetika fork, OTO-427) ---
    {
        "key": "facial",
        "names": {"es": "Facial", "en": "Facial Aesthetics", "fr": "Esthétique faciale", "ta": "முக அழகியல்"},
        "descriptions": {
            "es": "Tratamientos faciales estéticos",
            "en": "Facial aesthetic treatments",
            "fr": "Traitements esthétiques du visage",
            "ta": "முக அழகு சிகிச்சைகள்",
        },
        "display_order": 11,
        "icon": "i-lucide-sparkles",
    },
    {
        "key": "injectables",
        "names": {"es": "Inyectables", "en": "Injectables", "fr": "Injectables", "ta": "ஊசி சிகிச்சைகள்"},
        "descriptions": {
            "es": "Filler, bótox y rellenos",
            "en": "Fillers, botox and dermal fillers",
            "fr": "Comblement, botox et produits de comblement",
            "ta": "ஃபில்லர், போடாக்ஸ்",
        },
        "display_order": 12,
    ...
    {
        "key": "laser",
        "names": {"es": "Láser", "en": "Laser & Energy", "fr": "Laser & Énergie", "ta": "லேசர் சிகிச்சை"},
        "descriptions": {
            "es": "Tratamientos con láser y energía",
            "en": "Laser and energy-based treatments",
            "fr": "Traitements au laser et énergie",
            "ta": "லேசர் சிகிச்சைகள்",
        },
        "display_order": 13,
        "icon": "i-lucide-zap",
    },
    {
        "key": "skin",
        "names": {"es": "Piel", "en": "Skin & Peels", "fr": "Peau & Peelings", "ta": "தோல் சிகிச்சை"},
        "descriptions": {
            "es": "Tratamientos de piel y peeling químico",
            "en": "Skin treatments and chemical peels",
            "fr": "Traitements de la peau et peelings chimiques",
            "ta": "தோல் மற்றும் ரசாயன உரித்தல்",
        },
        "display_order": 14,
    ...
    {
        "key": "body",
        "names": {"es": "Cuerpo", "en": "Body Contouring", "fr": "Corps", "ta": "உடல் சிகிச்சை"},
        "descriptions": {
            "es": "Tratamientos corporales estéticos",
            "en": "Aesthetic body treatments",
            "fr": "Traitements corporels esthétiques",
            "ta": "உடல் அழகு சிகிச்சைகள்",
        },
        "display_order": 15,
...
TREATMENTS: dict[str, list[dict[str, Any]]] = {
    ...
    # --- Aesthetic clinic treatments (Otomedis estetika fork, OTO-427) ---
    "facial": [
        {
            "internal_code": "AES-FAC-CLEANSE",
            "names": {"es": "Limpieza facial profunda", "en": "Deep facial cleansing", "fr": "Nettoyage facial profond", "ta": "முக ஆழ சுத்திகரிப்பு"},
            "treatment_scope": "global_mouth",
        ...
        {
            "internal_code": "AES-FAC-HYDR",
            "names": {"es": "Hidratación facial", "en": "Facial hydration", "fr": "Hydratation du visage", "ta": "முக நீர்ச்சத்து சிகிச்சை"},
            "treatment_scope": "global_mouth",
        ...
        {
            "internal_code": "AES-FAC-MASS",
            "names": {"es": "Masaje facial lifting", "en": "Facial lifting massage", "fr": "Massage facial liftant", "ta": "முக லிஃப்டிங் மசாஜ்"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("55.00"),
    ...
    "injectables": [
        {
            "internal_code": "AES-INJ-BOTOX",
            "names": {"es": "Bótox (por área)", "en": "Botox (per area)", "fr": "Botox (par zone)", "ta": "போடாக்ஸ் (ஒரு பகுதி)"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("250.00"),
            "default_duration_minutes": 30,
            "vat_type": "standard",
        ...
        {
            "internal_code": "AES-INJ-FILLER-HA",
            "names": {"es": "Ácido hialurónico (1 ml)", "en": "Hyaluronic acid filler (1 ml)", "fr": "Acide hyaluronique (1 ml)", "ta": "ஹைலூரோனிக் அமிலம் (1 மிலி)"},
            "treatment_scope": "global_mouth",
        ...
        {
            "internal_code": "AES-INJ-LIP",
            "names": {"es": "Relleno labial", "en": "Lip filler", "fr": "Comblement des lèvres", "ta": "உதடு ஃபில்லர்"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("275.00"),
            "default_duration_minutes": 40,
            "vat_type": "standard",
            "pricing_strategy": "flat",
        },
        {
            "internal_code": "AES-INJ-THREAD",
            "names": {"es": "Hilos tensores", "en": "Thread lift", "fr": "Lifting par fils", "ta": "த்ரெட் லிஃப்ட்"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("800.00"),
            "default_duration_minutes": 90,
            "vat_type": "standard",
    ...
    "laser": [
        {
            "internal_code": "AES-LAS-REJUV",
            "names": {"es": "Rejuvenecimiento con láser", "en": "Laser skin rejuvenation", "fr": "Rajeunissement au laser", "ta": "லேசர் தோல் புத்துணர்வு"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("200.00"),
            "default_duration_minutes": 60,
            "vat_type": "standard",
        ...
        {
            "internal_code": "AES-LAS-HAIR",
            "names": {"es": "Depilación láser (sesión)", "en": "Laser hair removal (session)", "fr": "Épilation laser (séance)", "ta": "லேசர் முடி அகற்றல் (அமர்வு)"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("150.00"),
            "default_duration_minutes": 45,
            "vat_type": "standard",
        ...
        {
            "internal_code": "AES-LAS-PIGMENT",
            "names": {"es": "Láser de pigmentación", "en": "Pigment laser treatment", "fr": "Laser de pigmentation", "ta": "நிறமி லேசர் சிகிச்சை"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("180.00"),
            "default_duration_minutes": 45,
            "vat_type": "standard",
    ...
    "skin": [
        {
            "internal_code": "AES-SKN-MICRO",
            "names": {"es": "Microneedling", "en": "Microneedling", "fr": "Microneedling", "ta": "மைக்ரோநீட்லிங்"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("150.00"),
            "default_duration_minutes": 60,
            "vat_type": "standard",
        ...
        {
            "internal_code": "AES-SKN-PRP",
            "names": {"es": "Plasma rico en plaquetas (PRP)", "en": "Platelet-rich plasma (PRP)", "fr": "Plasma riche en plaquettes (PRP)", "ta": "பிளேட்லெட் ரிச் பிளாஸ்மா (PRP)"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("350.00"),
            "default_duration_minutes": 75,
            "vat_type": "standard",
        ...
        {
            "internal_code": "AES-SKN-PEEL",
            "names": {"es": "Peeling químico", "en": "Chemical peel", "fr": "Peeling chimique", "ta": "ரசாயன உரித்தல்"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("120.00"),
            "default_duration_minutes": 45,
            "vat_type": "standard",
    ...
    "body": [
        {
            "internal_code": "AES-BODY-CAVIT",
            "names": {"es": "Cavitación corporal", "en": "Body cavitation", "fr": "Cavitation corporelle", "ta": "உடல் கேவிட்டேஷன்"},
            "treatment_scope": "global_mouth",
        ...
        {
            "internal_code": "AES-BODY-RADIO",
            "names": {"es": "Radiofrecuencia corporal", "en": "Body radiofrequency", "fr": "Radiofréquence corporelle", "ta": "உடல் ரேடியோ அலை சிகிச்சை"},
            "treatment_scope": "global_mouth",
            "default_price": Decimal("120.00"),
            "default_duration_minutes": 60,
            "vat_type": "standard",
