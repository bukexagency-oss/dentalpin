...
class AestheticPlanModule(BaseModule):
    ...
    manifest = {
        ...
        "license": "BSL-1.1",
        "category": "official",
        "depends": ["patients", "agenda", "catalog", "catalog", "budget", "media"],
        "installable": True,
        "auto_install": True,
        "removable": False,
        "role_permissions": {
            "admin": ["*"],
            "dentist": ["*"],
            "hygienist": ["aesthetic_plans.read"],
            "assistant": [
                "aesthetic_plans.read",
                "aesthetic_plans.write",
            ],
            ...
            "receptionist": [
                "aesthetic_plans.read",
                "aesthetic_plans.write",
                "aesthetic_plans.close",
                "aesthetic_plans.reactivate",
            ],
        },
        "frontend": {
            "layer_path": "frontend",
            "navigation": [
                {
                    ...
                    "to": "/aesthetic-plans",
                    "permission": "aesthetic_plan.plans.read",
                    "order": 30,
                },
            ],
        },
