"""Add aesthetic_plan_item_sessions for multi-session billing.

Each ``AestheticPlanItem`` now owns 1..N sessions. Backfills one
...
revision: str = "ae_0006"
down_revision: str | None = "ae_0005"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("aesthetic_plan_items.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.execute(
        """
        INSERT INTO aesthetic_plan_item_sessions (
