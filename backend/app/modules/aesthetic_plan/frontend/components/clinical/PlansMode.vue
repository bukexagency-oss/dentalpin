...
import type { AestheticPlan, AestheticPlanDetail } from '~~/app/types'
...
const emit = defineEmits<{
  'plan-activated': [plan: AestheticPlan]
...
const selectedPlan = ref<AestheticPlanDetail | null>(null)
...
async function handleActivatePlan(plan: AestheticPlan) {
...
async function handleGenerateBudget(plan: AestheticPlan) {
...
function handleSchedule(plan: AestheticPlan) {
  router.push(`/appointments?patient_id=${plan.patient_id}`)
}

function handlePlanCreated(plan: AestheticPlan) {
