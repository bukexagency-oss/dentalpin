...
const emit = defineEmits<{
  'view': [plan: AestheticPlan]
  'activate': [plan: AestheticPlan]
  'schedule': [plan: AestheticPlan]
  'generate-budget': [plan: AestheticPlan]
}>()
...
const statusColors: Record<AestheticPlanStatus, UiColor> = {
  draft: 'warning',
  pending: 'warning',
  active: 'success',
  completed: 'info',
...
function getStatusColor(status: AestheticPlanStatus) {
